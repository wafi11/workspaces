...
export function SectionQuotaUser() {
  const { data: quota, isLoading } = useProfileQuota();
  ...
  return (
    <div className="grid grid-cols-1  sm:grid-cols-2 md::grid-cols-3 gap-3 lg:grid-cols-4">
      ...
      <MetricCard
        ...
        icon={
          <Ico d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2V9M9 21H5a2 2 0 0 1-2-2V9m0 0h18" />
        }
      />
      <MetricCard
        label="RAM"
      ...
      <MetricCard
        label="Storage"
        used={`${q.used_storage_gb} GB`}
        max={`${q.maxStorageGb} GB`}
        pct={pct(q.used_storage_gb, q.maxStorageGb)}
        icon={
          <Ico d="M22 12H2M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" />
        }
      />
    </div>
  );
